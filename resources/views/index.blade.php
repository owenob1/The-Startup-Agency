  		...
  		<div class="main">
  			...
  			<section class="content-section">
  				<div class="container-fluid">
  					<div class="row">
  						<header class="section-title text-center">
  							<h6 class="small-title">How we do it?</h6>
  			...
  			<section class="parallax-section" data-parallax="scroll" data-image-src="images/demo-img-3.jpg" data-speed="0.5">
  				<div class="container-fluid">
  					<div class="row">
  						<div class="col-md-5 black-half pt80 pb80">
                              <header class="section-title">
  								<h6 class="small-title">Who we are?</h6>
  								<h1 class="main-title">Little More.</h1>
  							</header>
  							<!-- /.section-title -->
  			...
  			<section class="content-section">
  				<div class="container">
  					<div class="row">
  						<header class="section-title text-center">
  							<h6 class="small-title">Is it affordable?</h6>
  							<h1 class="main-title">Our Pricing.</h1>
  							<p class="sub-title">It is as low as a cup of coffee per day!</p>
  						</header>
  						<!-- /.section-title -->
  						...
  						<div class="col-sm-4">
  							<div class="pricing-box">
  								...
  								<div class="pricing-body">
  									<ul>
  										<li>Basic Features <i class="icon ion-ios-help" data-toggle="tooltip" data-placement="right" title="Something more about this"></i></li>
  										<li>One User <i class="icon ion-ios-help" data-toggle="tooltip" data-placement="right" title="Something more about this"></i></li>
  										<li>10 Records <i class="icon ion-ios-help" data-toggle="tooltip" data-placement="right" title="Something more about this"></i></li>
  										<li>Basic Feature</li>
  										<li>Only One User</li>
  								...
  								<div class="pricing-foot">
  									<a href="https://themeforest.net/cart/configure_before_adding/18016228?license=regular&ref=salttechno&size=source&support=bundle_12month" target="_blank">Start Now</a>
  								</div>
  								<!-- /.pricing-foot -->
  							</div>
  							<!-- /.pricing-box -->
  						...
  						<div class="col-sm-4">
  							<div class="pricing-box popular">
  								...
  								<div class="pricing-body">
  									<ul>
  										<li>Basic Features <i class="icon ion-ios-help" data-toggle="tooltip" data-placement="right" title="Something more about this"></i></li>
  										<li>Five Users <i class="icon ion-ios-help" data-toggle="tooltip" data-placement="right" title="Something more about this"></i></li>
  										<li>100 Records <i class="icon ion-ios-help" data-toggle="tooltip" data-placement="right" title="Something more about this"></i></li>
  								...
  								<!-- /.pricing-body -->
  								<div class="pricing-foot">
  									<a href="https://themeforest.net/cart/configure_before_adding/18016228?license=regular&ref=salttechno&size=source&support=bundle_12month" target="_blank">Buy Now</a>
  								</div>
  								<!-- /.pricing-foot -->
  							</div>
  							<!-- /.pricing-box -->
  						...
  						<div class="col-sm-4">
  							<div class="pricing-box">
  								...
  								<div class="pricing-body">
  									<ul>
  										<li>Basic Features <i class="icon ion-ios-help" data-toggle="tooltip" data-placement="left" title="Something more about this"></i></li>
  										<li>Unlimited Users <i class="icon ion-ios-help" data-toggle="tooltip" data-placement="left" title="Something more about this"></i></li>
  										<li>Unlimited Records <i class="icon ion-ios-help" data-toggle="tooltip" data-placement="left" title="Something more about this"></i></li>
  										<li>All Features</li>
