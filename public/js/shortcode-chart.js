...
$(function($) {
    ...
    var myBarChart = new Chart(ctx3).Bar(data3, options3);
    ...
    var myBarChart2 = new Chart(ctx4).Bar(data4, options4);
    ...
    var myRadarChart = new Chart(ctx5).Radar(data5, options5);
    ...
    var myRadarChart2 = new Chart(ctx6).Radar(data6, options6);
    ...
    // For a pie chart
    var myPieChart = new Chart(ctx7).Pie(data7,options7);

    //chart-8
    var ctx8 = $("#chart-8").get(0).getContext("2d");
    ...
    var myDoughnutChart = new Chart(ctx8).Doughnut(data8,options8);
